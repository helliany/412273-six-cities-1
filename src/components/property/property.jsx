...
const Property = (props) => {
  const {offer: {images, isPremium, title, isFavorite, rating, bedrooms, maxAdults, price, goods, host, description}} = props;
      ...
      <div className="property__container container">
        <div className="property__wrapper">
          ...
          <div className="property__rating rating">
            ...
            <span className="property__rating-value rating__value">{getRating()}</span>
          </div>
